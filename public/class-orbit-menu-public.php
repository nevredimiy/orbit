...
class Orbit_Menu_Public {
	...
	public function __construct( $plugin_name, $version ) {
		...
		add_shortcode( 'orbit-menu', array($this, 'show_orbit_menu') );

	}

	
	function show_orbit_menu() {
		$res = get_option( 'orbit_menu_name_cat' );
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/orbit-menu-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/orbit-menu-public.js', array( 'jquery' ), $this->version, false );
